...
import {
  ...
  wt,
  xP
} from "./chunk-FUUWH3EC.js";
import {
  gt,
  yn
} from "./chunk-Q64BDUCC.js";
import {
...
var E = (r2, e) => () => (e || r2((e = { exports: {} }).exports, e), e.exports);
var v = (r2, e, n2, t2) => {
  if (e && typeof e == "object" || typeof e == "function")
    for (let a2 of F(e))
      !w.call(r2, a2) && a2 !== n2 && u(r2, a2, { get: () => e[a2], enumerable: !(t2 = B(e, a2)) || t2.enumerable });
  return r2;
};
var I = (r2, e, n2) => (n2 = r2 != null ? C(h(r2)) : {}, v(e || !r2 || !r2.__esModule ? u(n2, "default", { value: r2, enumerable: true }) : n2, r2));
var x = E((T2) => {
  Object.defineProperty(T2, "__esModule", { value: true }), T2.isEqual = function() {
    var r2 = Object.prototype.toString, e = Object.getPrototypeOf, n2 = Object.getOwnPropertySymbols ? function(t2) {
      return Object.keys(t2).concat(Object.getOwnPropertySymbols(t2));
    } : Object.keys;
    return function(t2, a2) {
      return function i2(o2, s2, p2) {
        var g2, y2, d2, c2 = r2.call(o2), b2 = r2.call(s2);
        if (o2 === s2)
          return true;
        if (o2 == null || s2 == null)
          return false;
        if (p2.indexOf(o2) > -1 && p2.indexOf(s2) > -1)
          return true;
        if (p2.push(o2, s2), c2 != b2 || (g2 = n2(o2), y2 = n2(s2), g2.length != y2.length || g2.some(function(A3) {
          return !i2(o2[A3], s2[A3], p2);
        })))
          return false;
        switch (c2.slice(8, -1)) {
          case "Symbol":
          ...
          case "Set":
          case "Map":
            g2 = o2.entries(), y2 = s2.entries();
            do
              if (!i2((d2 = g2.next()).value, y2.next().value, p2))
                return false;
            while (!d2.done);
            return true;
          case "ArrayBuffer":
          ...
          case "Array":
            ...
            for (d2 = 0; d2 < o2.length; d2++)
              if ((d2 in o2 || d2 in s2) && (d2 in o2 != d2 in s2 || !i2(o2[d2], s2[d2], p2)))
                return false;
            return true;
          case "Object":
            return i2(e(o2), e(s2), p2);
          default:
            return false;
        }
      }(t2, a2, []);
...
var l = I(x());
var S = (r2) => r2.map((e) => typeof e < "u").filter(Boolean).length;
var k = (r2, e) => {
  let { exists: n2, eq: t2, neq: a2, truthy: i2 } = r2;
  if (S([n2, t2, a2, i2]) > 1)
    throw new Error(`Invalid conditional test ${JSON.stringify({ exists: n2, eq: t2, neq: a2 })}`);
  if (typeof t2 < "u")
    return (0, l.isEqual)(e, t2);
  if (typeof a2 < "u")
    return !(0, l.isEqual)(e, a2);
  if (typeof n2 < "u") {
    let s2 = typeof e < "u";
    return n2 ? s2 : !s2;
  }
  return (typeof i2 > "u" ? true : i2) ? !!e : !e;
};
var P = (r2, e, n2) => {
  if (!r2.if)
    return true;
  let { arg: t2, global: a2 } = r2.if;
  if (S([t2, a2]) !== 1)
    throw new Error(`Invalid conditional value ${JSON.stringify({ arg: t2, global: a2 })}`);
  let i2 = t2 ? e[t2] : n2[a2];
  return k(r2.if, i2);
};
    ...
    return function e2(t2, n2, r2) {
      function s2(o3, u22) {
        if (!n2[o3]) {
          ...
          var l22 = n2[o3] = { exports: {} };
          t2[o3][0].call(l22.exports, function(e3) {
            var n3 = t2[o3][1][e3];
            return s2(n3 || e3);
          }, l22, l22.exports, e2, t2, n2, r2);
        }
...
var Preview = ({ isLoading, isColumn, columns, children, withSource, withToolbar = false, isExpanded = false, additionalActions, className, layout = "padded", ...props }) => {
  let [expanded, setExpanded] = (0, import_react.useState)(isExpanded), { source: source2, actionItem } = getSource(withSource, expanded, setExpanded), [scale, setScale] = (0, import_react.useState)(1), previewClasses = [className].concat(["sbdocs", "sbdocs-preview", "sb-unstyled"]), defaultActionItems = withSource ? [actionItem] : [], [additionalActionItems, setAdditionalActionItems] = (0, import_react.useState)(additionalActions ? [...additionalActions] : []), actionItems = [...defaultActionItems, ...additionalActionItems], { window: globalWindow4 } = globalThis, copyToClipboard = (0, import_react.useCallback)(async (text) => {
    let { createCopyToClipboardFunction } = await import("./components-CRGA5KGD.js");
...
var l2 = ["allowFullScreen", "allowTransparency", "autoComplete", "autoFocus", "autoPlay", "cellPadding", "cellSpacing", "charSet", "className", "classId", "colSpan", "contentEditable", "contextMenu", "crossOrigin", "encType", "formAction", "formEncType", "formMethod", "formNoValidate", "formTarget", "frameBorder", "hrefLang", "inputMode", "keyParams", "keyType", "marginHeight", "marginWidth", "maxLength", "mediaGroup", "minLength", "noValidate", "radioGroup", "readOnly", "rowSpan", "spellCheck", "srcDoc", "srcLang", "srcSet", "tabIndex", "useMap"].reduce((e2, n2) => (e2[n2.toLowerCase()] = n2, e2), { for: "htmlFor" });
...
var $e = be(2);
function we(e2, n2) {
  let t2 = n2 === 1, r2 = t2 ? ve : $e, i2 = t2 ? ke : xe, l22 = t2 ? me : ge;
...
`).match(i2), a2 = false;
    return { items: c2.map(function(e4, t3) {
      let i3 = l22.exec(e4)[0].length, o3 = new RegExp("^ {1," + i3 + "}", "gm"), s2 = e4.replace(o3, "").replace(l22, ""), d2 = t3 === c2.length - 1, u22 = s2.indexOf(`

`) !== -1 || d2 && a2;
      a2 = u22;
      let p2 = r3.inline, f3 = r3.list, h22;
      r3.list = true, u22 ? (r3.inline = false, h22 = s2.replace(ce, `

`)) : (r3.inline = true, h22 = s2.replace(ce, ""));
      let m2 = n3(h22, r3);
...
var Se = /^!\[(.*?)\]\( *((?:\([^)]*\)|[^() ])*) *"?([^)"]*)?"?\)/;
var Ce = [u2, m, g, S2, A, C2, L, N2, ke, ve, xe, $e];
var Ae = [...Ce, /^[^\n]+(?:  \n|\n{2,})/, O, z];
function Oe(e2) {
...
function Le(e2, n2, t2) {
  ...
  return i2.forEach(function(e3, n3) {
    e3.type === "26" ? n3 !== 0 && n3 !== i2.length - 1 && l22.push([]) : (e3.type !== "27" || i2[n3 + 1] != null && i2[n3 + 1].type !== "26" || (e3.text = e3.text.replace(q, "")), l22[l22.length - 1].push(e3));
  }), l22;
}
function Re(e2, n2, t2) {
  t2.inline = true;
  let r2 = Le(e2[1], n2, t2), i2 = e2[2].replace(Z, "").split("|").map(Te), l22 = function(e3, n3, t3) {
    return e3.trim().split(`
`).map(function(e4) {
      return Le(e4, n3, t3);
    });
  }(e2[3], n2, t2);
  return t2.inline = false, { align: i2, cells: l22, header: r2, type: "25" };
}
function ze(e2, n2) {
...
function De(e2, n2, t2) {
  ...
  let l22 = e2(n2, t2);
  return t2.inline = r2, t2.simple = i2, l22;
}
...
function Ve(t2 = "", r2 = {}) {
  ...
  function d2(e2, t3, ...l22) {
    ...
    }(e2, r2.overrides), n({}, t3, o2, { className: Ze(t3 == null ? void 0 : t3.className, o2.className) || void 0 }), ...l22);
  }
  function Z2(n2) {
    n2 = n2.replace(w2, "");
    let t3 = false;
    r2.forceInline ? t3 = true : r2.forceBlock || (t3 = F2.test(n2) === false);
    let i3 = oe2(J2(t3 ? n2 : `${n2.trimEnd().replace(ie, "")}

`, { inline: t3 }));
    for (; typeof i3[i3.length - 1] == "string" && !i3[i3.length - 1].trim(); )
      i3.pop();
    if (r2.wrapper === null)
      return i3;
    let l22 = r2.wrapper || (t3 ? "span" : "div"), o2;
    if (i3.length > 1 || r2.forceWrapper)
      o2 = i3;
    else {
      if (i3.length === 1)
        return o2 = i3[0], typeof o2 == "string" ? d2("span", { key: "outer" }, o2) : o2;
      o2 = null;
    }
    return React15.createElement(l22, { key: "outer" }, o2);
  }
  function q2(n2) {
    let t3 = n2.match(a);
    return t3 ? t3.reduce(function(n3, t4, r3) {
      ...
      if (i3 !== -1) {
        let o2 = function(e2) {
          return e2.indexOf("-") !== -1 && e2.match(R) === null && (e2 = e2.replace(B2, function(e3, n4) {
            return n4.toUpperCase();
          })), e2;
        }(t4.slice(0, i3)).trim(), c2 = function(e2) {
          let n4 = e2[0];
          return (n4 === '"' || n4 === "'") && e2.length >= 2 && e2[e2.length - 1] === n4 ? e2.slice(1, -1) : e2;
        }(t4.slice(i3 + 1).trim()), a2 = l2[o2] || o2, s2 = n3[a2] = function(e2, n4) {
          ...
          }, {}) : e2 === "href" || e2 === "src" ? Ne(n4) : (n4.match(M) && (n4 = n4.slice(1, n4.length - 1)), n4 === "true" || n4 !== "false" && n4);
        }(o2, c2);
        typeof s2 == "string" && (O.test(s2) || z.test(s2)) && (n3[a2] = React15.cloneElement(Z2(s2.trim()), { key: r3 }));
      } else
        t4 !== "style" && (n3[l2[t4] || t4] = true);
      return n3;
    }, {}) : null;
  }
  let V2 = [], X2 = {}, Q2 = { 0: { match: Ue(u2), order: 1, parse: (e2, n2, t3) => ({ children: n2(e2[0].replace(p, ""), t3) }), render: (e2, n2, t3) => d2("blockquote", { key: t3.key }, n2(e2.children, t3)) }, 1: { match: je(f2), order: 1, parse: We, render: (e2, n2, t3) => d2("br", { key: t3.key }) }, 2: { match: Ue(h2), order: 1, parse: We, render: (e2, n2, t3) => d2("hr", { key: t3.key }) }, 3: { match: Ue(g), order: 0, parse: (e2) => ({ lang: void 0, text: e2[0].replace(/^ {4}/gm, "").replace(/\n+$/, "") }), render: (e2, t3, r3) => d2("pre", { key: r3.key }, d2("code", n({}, e2.attrs, { className: e2.lang ? `lang-${e2.lang}` : "" }), e2.text)) }, 4: { match: Ue(m), order: 0, parse: (e2) => ({ attrs: q2(e2[3] || ""), lang: e2[2] || void 0, text: e2[4], type: "3" }) }, 5: { match: Ie(y), order: 3, parse: (e2) => ({ text: e2[2] }), render: (e2, n2, t3) => d2("code", { key: t3.key }, e2.text) }, 6: { match: Ue(b), order: 0, parse: (e2) => (V2.push({ footnote: e2[2], identifier: e2[1] }), {}), render: Ge }, 7: { match: Me(v2), order: 1, parse: (e2) => ({ target: `#${r2.slugify(e2[1])}`, text: e2[1] }), render: (e2, n2, t3) => d2("a", { key: t3.key, href: Ne(e2.target) }, d2("sup", { key: t3.key }, e2.text)) }, 8: { match: Me(E2), order: 1, parse: (e2) => ({ completed: e2[1].toLowerCase() === "x" }), render: (e2, n2, t3) => d2("input", { checked: e2.completed, key: t3.key, readOnly: true, type: "checkbox" }) }, 9: { match: Ue(r2.enforceAtxHeadings ? C2 : S2), order: 1, parse: (e2, n2, t3) => ({ children: De(n2, e2[2], t3), id: r2.slugify(e2[2]), level: e2[1].length }), render: (e2, n2, t3) => d2(`h${e2.level}`, { id: e2.id, key: t3.key }, n2(e2.children, t3)) }, 10: { match: Ue(A), order: 0, parse: (e2, n2, t3) => ({ children: De(n2, e2[1], t3), level: e2[2] === "=" ? 1 : 2, type: "9" }) }, 11: { match: je(O), order: 1, parse(e2, n2, t3) {
    let [, r3] = e2[3].match(le), i3 = new RegExp(`^${r3}`, "gm"), l22 = e2[3].replace(i3, ""), o2 = (a2 = l22, Ae.some((e3) => e3.test(a2)) ? _e2 : De);
    var a2;
    let s2 = e2[1].toLowerCase(), d3 = c.indexOf(s2) !== -1, u22 = { attrs: q2(e2[2]), noInnerParse: d3, tag: (d3 ? s2 : e2[1]).trim() };
    return t3.inAnchor = t3.inAnchor || s2 === "a", d3 ? u22.text = e2[3] : u22.children = o2(n2, l22, t3), t3.inAnchor = false, u22;
      ...
      for (; r3; ) {
        ...
        for (; c2 < n2.length; ) {
          ...
          if (d3) {
            ...
            n3.type == null && (n3.type = a2), l22.push(n3), o2 = e3;
            break;
          }
          c2++;
        }
...
`).replace($, "").replace(W, "    ");
    ...
    return function(t3, r3, i3) {
      let l22 = e2[t3.type].render;
      return n2 ? n2(() => l22(t3, r3, i3), t3, r3, i3) : l22(t3, r3, i3);
    };
  }(Q2, r2.renderRule), function e2(n2, t3 = {}) {
    if (Array.isArray(n2)) {
      let r3 = t3.key, i3 = [], l22 = false;
      for (let r4 = 0; r4 < n2.length; r4++) {
        t3.key = r4;
        let o2 = e2(n2[r4], t3), c2 = typeof o2 == "string";
        c2 && l22 ? i3[i3.length - 1] += o2 : o2 !== null && i3.push(o2), l22 = c2;
      }
      return t3.key = r3, i3;
    }
    return ce2(n2, e2, t3);
...
var index_modern_default = (n2) => {
  let { children: r2 = "", options: i2 } = n2, l22 = function(e2, n3) {
    if (e2 == null)
      return {};
  ...
  return React15.cloneElement(Ve(r2, i2), l22);
};
...
var LazyColorControl = (0, import_react.lazy)(() => import("./Color-F6OSRLHC-FCKRYROD.js"));
...
var require_get_intrinsic = __commonJS22({ "node_modules/get-intrinsic/index.js"(exports, module) {
  ...
  }() : throwTypeError, hasSymbols = require_has_symbols()(), getProto = Object.getPrototypeOf || function(x22) {
    return x22.__proto__;
...
//# sourceMappingURL=chunk-NBKHUHLS.js.map
